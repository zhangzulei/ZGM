 ...
 */
@Repository
public interface GuildMemberMapper extends BaseMapper<ZgmGuildPeo> {
     ...
     * @return 成员列表
     */
    List<ZgmGuildPeo> findByStateAndGuild(@Param("state") Integer state, @Param("guildId") String guildId);
     ...
     * @return 成员信息
     */
    ZgmGuildPeo findById(@Param("id") Integer id,@Param("guildId") String guildId);
     ...
     * @return 结果集
     */
    List<ZgmGuild> likeFindPeo(@Param("guildId") String guildId,
